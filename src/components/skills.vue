  ...
  <v-container>
    <div class="d-flex flex-column d-sm-flex flex-sm-row offset-md-1 mt-9">
      ...
      >
        ...
        <p>
          I am fully capable of building a lot of things. Whether it's a full
          stack application, a webshop or just a website for you - I got you. I
          can develop REST APIs, work with MySQL and NoSQL databases or create a
          website for you or your company. I can also work with Golang or create
          Unit or End2End tests for applications as well as setup CI/CD
          pipelines to significantly improve workflow and automation. Aside from
          technical skills I have accumulated a good amount of knowledge about
          various practices, architectures and industry standards. I'm more than
          capable of working with open source CMS's such as WordPress and
          SilverStripe.
        </p>
        <v-btn
          id="buttonMain"
          class="hvr-glow pa-2 px-10 mt-7"
          href="https://github.com/japhmayor"
          target="_blank"
          outlined
          ripple
      ...
      <v-col class="offset-md-1 offset-sm-1" cols="12" md="6" sm="5">
        <div id="myCanvasContainer" class="d-flex justify-center">
          <canvas width="auto" height="400" id="myCanvas">
            ...
            <ul>
              <a href="javascript:function() { return false; }">Golang</a>
              <a href="javascript:function() { return false; }">HTML5</a>
              <a href="javascript:function() { return false; }">CSS3</a>
              <a href="javascript:function() { return false; }">Angular</a>
              ...
              <a href="javascript:function() { return false; }">Vue</a>
              ...
              <a href="javascript:function() { return false; }">Node</a>
