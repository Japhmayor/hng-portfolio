  ...
  <v-container>
    ...
    >
      <v-col cols="12" md="4" sm="5">
        <p id="primaryText">
          I'm Bontus. Currently broadening my horizons and getting Web
          Development Internship with HNG. <br /><br />
      ...
      <v-col class="offset-md-1" cols="12" md="6" sm="5">
        <p>
          My professional area of focus lies in web development, designing web
           products, SEO & user research. I enjoy designing and
        ...
        <v-btn
          id="buttonMain"
          class="hvr-glow pa-2 px-10 mt-7"
          href="https://www.linkedin.com/in/ikwechegh-ukandu/"
          target="_blank"
          outlined
          ripple
          color="indigo accent-2"
